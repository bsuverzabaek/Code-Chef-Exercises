...
Today Chef has cooked the brand new circular cake. To split the cake Chef can make several (possibly, zero) cuts. 
Each cut should be a straight line going from the center of the cake to its border. 
Also, the angle between any two cuts should have positive integer value (Chef measure all the angles in degrees). 
Chef consider two pieces of cake equal if the appropriate angles are equal.

<img width="314" alt="Screen Shot 2021-02-06 at 3 55 03 PM" src="https://user-images.githubusercontent.com/69542867/107131464-b6208d80-6893-11eb-8b43-525026097d98.png">
